...
import { Home, MyInfo, People, Hiring, Reports, Files, Payroll, TimeAttendance, Settings, Inbox, NewEmployeePage, DatePickerDemo, CreateJobOpening, JobAIPrototype } from './pages';
