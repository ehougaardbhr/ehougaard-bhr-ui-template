...
| `generate_workforce_analytics` | Produce headcount, turnover, tenure, and compensation analytics by department, location, or level. | LIVE | `analytics.ts`, `employees.ts` (full roster) |
